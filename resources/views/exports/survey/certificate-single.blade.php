...
<body>
    <div class="page">
        ...
        <div class="content-wrapper">
            ...
            <div class="subtitle">Apresiasi Mitra Survey</div>

            <!-- Statement -->
            <p class="statement">Diberikan kepada mitra bernama :</p>
            ...
            <div class="description">
                Telah menunjukkan <span class="highlight">dedikasi dan kinerja yang baik</span> dalam melaksanakan
                kegiatan survey <span class="highlight">{{ $certificate['survey_name'] }} ({{ $certificate['survey_code'] }})</span>
                dengan <span class="highlight">pencapaian target yang memuaskan</span>
                pada Tim <span class="highlight">{{ $certificate['team_name'] }}</span>.
            </div>

            <!-- Details -->
            <div class="details-box">
                <p><strong>Survey:</strong> {{ $certificate['survey_name'] }} ({{ $certificate['survey_code'] }})</p>
                <p><strong>Target:</strong> {{ $certificate['target'] }} dokumen</p>
                <p><strong>Nilai Kualitas Data:</strong> {{ $certificate['aspek1'] }}</p>
                <p><strong>Nilai Ketepatan Waktu:</strong> {{ $certificate['aspek2'] }}</p>
                <p><strong>Nilai Pemahaman Kerja:</strong> {{ $certificate['aspek3'] }}</p>
                <p><strong>Nilai Rata-rata:</strong> {{ $certificate['score'] }}</p>
